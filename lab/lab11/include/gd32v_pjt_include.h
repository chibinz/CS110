...
#define PA_OUT(n, s)                                                                                                   \
    ({                                                                                                                 \
        if (s % 2)                                                                                                     \
            gpio_bit_set(GPIOA, GPIO_PIN_##n);                                                                         \
        else                                                                                                           \
            gpio_bit_reset(GPIOA, GPIO_PIN_##n);                                                                       \
    })
...
#define PB_OUT(n, s)                                                                                                   \
    ({                                                                                                                 \
        if (s % 2)                                                                                                     \
            gpio_bit_set(GPIOB, GPIO_PIN_##n);                                                                         \
        else                                                                                                           \
            gpio_bit_reset(GPIOB, GPIO_PIN_##n);                                                                       \
    })
...
#define PC_OUT(n, s)                                                                                                   \
    ({                                                                                                                 \
        if (s % 2)                                                                                                     \
            gpio_bit_set(GPIOC, GPIO_PIN_##n);                                                                         \
        else                                                                                                           \
            gpio_bit_reset(GPIOC, GPIO_PIN_##n);                                                                       \
    })
