...
("CPU addi test",AbsoluteTestCase(os.path.join(file_locations,'CPU-addi.circ'), os.path.join(file_locations,'output/CPU-addi.out'), os.path.join(file_locations,'reference_output/CPU-addi.out'),1)),
  ...
  ("CPU branch test",AbsoluteTestCase(os.path.join(file_locations,'CPU-branch.circ'), os.path.join(file_locations,'output/CPU-branch.out'), os.path.join(file_locations,'reference_output/CPU-branch.out'),1)),
